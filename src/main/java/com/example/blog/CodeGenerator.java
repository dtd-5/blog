...
public class CodeGenerator {
     ...
     * 数据库连接字符
     */
    private static final String URL = "jdbc:mysql://10.62.0.129:3306/eblog?useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone=UTC";

    /**
     * 示例：private static final String PARENT_PACKAGE_NAME = "com.example.mybatisplusdemo";
     */
    private static final String PARENT_PACKAGE_NAME = "com.example.blog";
...
//                        .other("other")
                        ...
                        .pathInfo(
                                new HashMap<OutputFile, String>() {{
                                    ...
                                    // mapper.xml文件的保存路径
                                    put(OutputFile.mapper, mapperXmlPath);
                                    // service层接口的保存路径
